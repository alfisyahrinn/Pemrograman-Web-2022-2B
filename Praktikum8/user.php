            ...
            <tr>
              ...
              <td class="d-flex">
                ...
                <a href="proses/deleteData.php?id=<?= $rowUser['id']; ?>">
                  <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteData" onclick="return confirm('Apakah Anda yakin akan menghapus Data ini?')">
                ...
                <a href="proses/deleteData.php?id=<?= $rowUser['id']; ?>">
                  <button class="btn btn-secondary ms-1" data-bs-toggle="modal" data-bs-target="#deleteData" onclick="return confirm('Apakah Anda yakin akan menghapus Data ini?')">
